...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    loaded = true,
    path = "/home/ghost/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["colorbuddy.nvim"] = {
    loaded = true,
    path = "/home/ghost/.local/share/nvim/site/pack/packer/start/colorbuddy.nvim",
  ...
  ["neosolarized.nvim"] = {
    loaded = true,
    path = "/home/ghost/.local/share/nvim/site/pack/packer/start/neosolarized.nvim",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/ghost/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/ghost/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
